 ...
 * Here we'll create a publisher ("talker") node which will continually broadcast a message.
 */
int main(int argc, char **argv)
{
   ...
   */
  // Here we instantiate a Publisher object and we say that we want to construct a 
  // message of type "String" with the name "chatter".
  // "chatter", then, will be the name of the Topic we are sending messages to. 
   ...
   * In this case we tell it we want to run at 5Hz (5 messages per second). */  
  ...
  // While ROS is correctly running: Loop
  while (ros::ok())
  {
    /**
     * This is a message object of type String. 
     * You stuff it with data, and then publish it.
     */
    std_msgs::String msg;
    ...
    // We transform this into a String by using str()
    msg.data = ss.str();
    ...
    // Add up a unit (1) to the variable "count"
    ++count;
  }
